          ...
          <div className="tab-content">
            <div className="tab-pane fade show active"id="pills-login"role="tabpanel"aria-labelledby="tab-login">
              ...
              <form>
                ...
                <div className='lead text-center m-20'>A létrehozást követően automatikusan átkerülsz ebbe a klánba moderátorként. Jogkörödbe tartoznak majd a felhasználók hozzáadása és eltávolítása.</div>
                <div className='p-20'>
                  <Button2 content="Létrehozás" />
                </div>
              </form>
            </div>
          </div>
