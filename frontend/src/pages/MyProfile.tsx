            ...
            <div className="col-lg-4">
              <div className="card mb-4 bg-dark-4">
                <div className="card-body text-center">
                  ...
                  <p className="my-3 lead text-white fw-bold text-center">john_smith83</p>
                  <hr/>
                  ...
                  <hr/>
             {
                    editDescr ?
                      ...
                      :
                      <>
                        <p className='myProfileData p-15 mb-5'>Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door...</p>
                        ...
                        <div className="row m-5">
                          ...
                          <div className="col-sm-8 row">
                            <div className="col-md-6 col-9 border">
                              <div className="form-group myform-group">
                                <input type="text" id="omazonosito" className="myform-control form-control required bg-dark p-10 d-flex align-items-center border" required />
                              </div>
                            </div>
