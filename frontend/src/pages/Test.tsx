  ...
  return (
    <div>
      ...
      <div className='d-flex flex-row'>
        <div className='col-4 lightgreybg'>
          <div className="reviewList">
            <div className='reviewList_itemcontainer'>
              <div className='reviewList_item d-flex flex-row gap-2'>
                <div className='col p-10'>
                  <figure><img src='assets/images/post-1-sm.jpg' className='reviewThumbnail'></img></figure>
                </div>
                <div className='col-5'>
                ...
                <div className="col-3 text-center m-auto fw-bold text-warning">Függőben <span className="lead">&#10710;</span></div>
              </div>
            </div>
          </div>
        </div>
