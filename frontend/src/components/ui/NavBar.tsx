...
function NavBar() {
    ...
    const [isDrawerDropdownMenuOpen, setIsDrawerDropdownMenuOpen] = useState(false);
                        ...
                        <div className="flex h-16 items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="block md:hidden">
                                    <button onClick={() => setIsDrawerOpen(prev => !prev)} className="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75 dark:bg-gray-800 dark:text-white dark:hover:text-white/75">
